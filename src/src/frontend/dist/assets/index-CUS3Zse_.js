...
const PUMP_LINK = "https://pump.fun/coin/rGFb4yejWEuMKT2FPjgYpV8vwvvsE8taPcd9k6xpump";
const TG_LINK = "https://t.me/RUG_KILLERS_RnD";
const X_LINK = "https://x.com/pumpai100?s=21";
const BOOT_IMG = "/assets/uploads/img_0085-019d1df5-dfe8-7468-857a-c81ce1f66891-1.jpeg";
function useCopyCA() {
  return (text) => {
    ...
    ).catch(() => ue.error("Copy failed — use Ctrl+C"));
  };
}
...
function DustParticles({ count = 18 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      "aria-hidden": true,
      children: PARTICLES.slice(0, count).map((p, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "bg-coal/96 shadow-lg shadow-black/60 backdrop-blur-md border-b border-copper/20" : "bg-coal/70 backdrop-blur-sm border-b border-transparent"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "max-w-7xl mx-auto px-6 h-16 flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl", children: menuOpen ? "✕" : "☰" })
            }
          )
        ] }),
        menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden bg-coal/98 border-t border-copper/20 px-6 py-4 flex flex-col gap-4", children: [
...
function Hero() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DustParticles, { count: 18 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            "aria-hidden": true,
            style: {
              background: "radial-gradient(ellipse 70% 60% at 50% 55%, rgba(255,176,0,0.05) 0%, transparent 70%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex flex-col items-center text-center max-w-3xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: "font-body text-[10px] font-semibold tracking-[0.3em] uppercase mb-8",
              style: { color: "#b87333" },
              children: "SOLANA MEME COIN"
            }
          ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "h1",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-amber text-glow-amber", children: "was this boot.”" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm sm:text-base text-silver/55 mb-12 leading-relaxed max-w-md", children: "Every scuff, every crack… tells a story." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-xl mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-[10px] font-semibold tracking-[0.25em] text-silver/35 mb-2.5 text-left uppercase", children: "Contract Address" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mine-tag flex items-center gap-3 px-5 py-4 rounded-lg", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "font-mono text-[11px] sm:text-xs text-amber flex-1 break-all leading-relaxed", children: CA }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center gap-4 mb-12", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: PUMP_LINK,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                children: "↓ ENTER THE LEGACY"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-6", children: ["✅ SOLANA", "✅ PUMP.FUN", "✅ 0% TAX", "✅ 1B SUPPLY"].map(
...
function Marquee() {
  const text = "DEEPER THAN ANYONE DARED • SOLE TO THE EARTH • LEGACY IN LEATHER • $bOOt TO THE MOON • THE TUNNELS REMEMBER • RUG KILLERS • ";
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "absolute inset-0 pointer-events-none",
            style: {
              background: "repeating-linear-gradient(-45deg, rgba(255,176,0,0.04) 0px, rgba(255,176,0,0.04) 1px, transparent 1px, transparent 20px)"
            },
            "aria-hidden": true
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ticker-inner", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs font-bold tracking-[0.25em] text-amber", children: repeated }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
  ...
  const cards = [
    {
      icon: "👢",
      title: "Heel",
      quote: "This heel survived the tunnel collapse… it carries the memory of every man who didn't come back."
    },
    {
      icon: "💧",
      title: "Sole",
      quote: "Miles of tunnels no map shows. Steps too heavy for one man alone. The earth knows the weight."
    },
    {
      icon: "🔥",
      title: "Burn",
      quote: "A close call with fire deep in the mine. It came out. He came out. They both wore the scars."
    },
    {
      icon: "⛏️",
      title: "Cracks",
      quote: "Leather bends but doesn't break. Neither did he. Every crack is a story he chose not to tell."
    }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-[9px] font-semibold tracking-[0.35em] text-copper text-center mb-3 uppercase", children: "The Object" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-white text-center mb-16", children: "THE ARTIFACT" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-5", children: cards.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold text-amber", children: c.title })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
...
function Legend() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DustParticles, { count: 12 }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-4xl mx-auto text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-[9px] font-semibold tracking-[0.35em] text-copper mb-4 uppercase", children: "The Story" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl sm:text-5xl font-bold text-white mb-10 text-glow-amber", children: "THE MINER’S LEGEND" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-lg mx-auto space-y-0 mb-16", children: [
          ...
          ].map((line) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "p",
              {
            ...
            !line.includes("so do we") && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "copper-divider" })
          ] }, line)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-5", children: lore.map((a, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl mb-4", children: a.icon }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-silver/70 leading-relaxed italic", children: a.text })
              ]
            },
            a.icon
          )) })
...
function Encounters() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      style: { backgroundColor: "#0d0d0d" },
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-[9px] font-semibold tracking-[0.35em] text-copper text-center mb-3 uppercase", children: "The People" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-white text-center mb-16", children: "THE ENCOUNTERS" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-5", children: cols.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", children: c.lines.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
...
function TheChoice() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DustParticles, { count: 14 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            "aria-hidden": true,
            style: {
              background: "linear-gradient(to bottom, rgba(255,176,0,0.06) 0%, transparent 60%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-2xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative inline-block mb-12", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: BOOT_IMG,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-8 leading-snug", children: [
            "“You can leave the boot behind…",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#b87333" }, children: "Or walk the tunnels he never left.”" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
...
function Tokenomics() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-[9px] font-semibold tracking-[0.35em] text-copper text-center mb-3 uppercase", children: "The Numbers" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-white text-center mb-14", children: "TOKENOMICS" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 mb-12", children: stats.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-[9px] font-bold tracking-widest text-silver/40 mb-3 uppercase", children: s.label }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-xl sm:text-2xl font-bold text-amber text-glow-amber mb-1", children: s.value }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between mb-2.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-[10px] font-semibold tracking-widest text-silver/50 uppercase", children: b.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-body text-[10px] font-bold text-amber", children: [
              b.pct,
              "%"
            ] })
          ] }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-[9px] font-semibold tracking-[0.35em] text-copper text-center mb-3 uppercase", children: "The Path" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-white text-center mb-14", children: "HOW TO BUY" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: steps.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-body text-xs font-bold tracking-widest text-amber mb-2 uppercase", children: s.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-silver/60 leading-relaxed", children: s.desc })
              ] })
            ]
          },
          s.n
        )) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mt-14", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: PUMP_LINK,
            target: "_blank",
...
function Roadmap() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      style: { backgroundColor: "#111111" },
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-[9px] font-semibold tracking-[0.35em] text-copper text-center mb-3 uppercase", children: "The Journey" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-white text-center mb-14", children: "ROADMAP" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-5", children: phases.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-[9px] font-semibold tracking-widest text-silver/35 mb-2 uppercase", children: p.phase }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h3",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: p.items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2.5 items-start", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-amber mt-0.5 flex-shrink-0 text-xs", children: "▸" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm text-silver/60 leading-snug", children: item })
              ] }, item)) })
            ]
          },
          p.phase
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-[9px] font-semibold tracking-[0.35em] text-copper mb-3 uppercase", children: "The Crew" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-white mb-14", children: "JOIN THE CREW" }),
            ...
            "a",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-xs font-bold tracking-widest text-amber group-hover:text-white transition-colors duration-200 mb-1 uppercase", children: "Telegram" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-sm text-silver/50", children: "Rug Killers HQ — join the crew" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-copper text-lg group-hover:translate-x-1 transition-transform duration-200", children: "→" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              "data-ocid": "community.link",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", children: "𝕏" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-xs font-bold tracking-widest text-amber group-hover:text-white transition-colors duration-200 mb-1 uppercase", children: "X / Twitter" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-sm text-silver/50", children: "Follow for updates & dispatches" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-copper text-lg group-hover:translate-x-1 transition-transform duration-200", children: "→" })
              ]
            }
...
function FAQ() {
  ...
  const contentRefs = reactExports.useRef([]);
  const items = [
    {
      q: "WHAT IS $bOOt?",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-[9px] font-semibold tracking-[0.35em] text-copper text-center mb-3 uppercase", children: "The Answers" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-white text-center mb-14", children: "FAQ" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: items.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              backgroundColor: "#1a1a1a",
              borderColor: open === i ? "rgba(184,115,51,0.5)" : "rgba(184,115,51,0.15)"
            },
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs font-bold tracking-wider text-amber uppercase", children: item.q }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 pb-6", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "copper-divider mb-4" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-silver/60 leading-relaxed", children: item.a })
                  ] })
                }
              )
            ]
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "footer",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-12 mb-14", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-xl font-bold text-amber", children: "$bOOt" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-sm text-silver/40 leading-relaxed mb-5", children: [
              "The boot-themed meme coin on Solana.",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              "Community-driven. No tax. Fair launch."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mine-tag p-4 rounded-lg", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-[9px] font-semibold tracking-widest text-silver/30 mb-1.5 uppercase", children: "CA" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "font-mono text-[9px] text-amber flex-1 break-all", children: CA }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-body text-[10px] font-bold tracking-widest text-amber mb-5 uppercase", children: "Community" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-body text-[10px] font-bold tracking-widest text-amber mb-5 uppercase", children: "Resources" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3.5", children: ["TOKENOMICS", "ROADMAP", "HOW TO BUY"].map((r) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "copper-divider mb-8" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-between gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-sm font-bold italic text-silver/30 tracking-wider", children: "THE TUNNELS REMEMBER" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs text-silver/30", children: "CONTINUE?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: PUMP_LINK,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-[10px] text-silver/25", children: [
            "© ",
            year,
            ". Built with ♥ using",
            " ",
...
function App() {
  useScrollReveal();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", style: { backgroundColor: "#0d0d0d" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster, { position: "top-right" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Hero, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Marquee, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Artifact, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Legend, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Encounters, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TheChoice, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tokenomics, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(HowToBuy, {}),
...
const PaginationResult_1 = Record({
  "currentPage": Nat,
  "items": Vec(Category),
  "totalPages": Nat,
  "totalItems": Nat,
...
Service({
  ...
  "addAllowedOrigin": Func([Text], [Text], []),
  "addCategory": Func([Text, Text, Opt(Text)], [], []),
  "addProduct": Func(
    [Text, Text, Nat, Text, Opt(Text)],
    [],
    []
  ),
  "addTransaction": Func([Text], [Opt(Status)], []),
  "clearAllCategories": Func([], [Text], []),
  "clearAllProducts": Func([], [Text], []),
  "clearAllTransactions": Func([], [Text], []),
  "createCheckoutSession": Func(
    [Vec(CheckoutLineItem), Text, Text],
    [Text],
    []
  ),
  "deleteCategory": Func([Text], [], []),
  "deleteProduct": Func([Nat], [], []),
  "deleteTransaction": Func([Text], [Bool], []),
  "editProduct": Func(
    [Nat, Text, Text, Nat, Text, Opt(Text)],
    [],
    []
  ),
  "getAdmins": Func([], [Vec(Principal2)], ["query"]),
  "getAllCategories": Func([], [Vec(Text)], ["query"]),
  "getAllowedOrigins": Func([], [Vec(Text)], ["query"]),
  "getCategories": Func(
    [Opt(Nat), Opt(Nat)],
    [PaginationResult_1],
    ["query"]
  ...
  "getProductsByCategory": Func(
    [Text, Opt(Nat), Opt(Nat)],
    [PaginationResult],
    ["query"]
  ),
  "getTransaction": Func([Text], [Opt(Status)], ["query"]),
  "getTransactionLineItems": Func(
    [Text, Opt(Text)],
    [Text],
    []
  ),
  "getTransactions": Func(
    [],
    [Vec(Tuple(Text, Status))],
    ["query"]
  ),
  "getTransactionsByPrincipal": Func(
    [],
    [Vec(Tuple(Text, Status))],
    ["query"]
  ),
  "getUser": Func([], [Opt(Text)], ["query"]),
  "initializeAuth": Func([], [], []),
  "initializeData": Func(
    [Vec(Category), Vec(Product), Vec(Text)],
    [Text],
    []
  ),
  "isAdmin": Func([], [Bool], ["query"]),
  "removeAdmin": Func([Principal2], [], []),
  "removeAllowedOrigin": Func([Text], [Text], []),
  "setAuthorization": Func([Text], [], []),
  "setUser": Func([Text], [], []),
  "transform": Func(
    [
      Record({
